...
import '../../features/mushaf/presentation/mushaf_navigation.dart';
...
class _MiniPlayerState extends State<MiniPlayer> {
  ...
  /// Opens the mushaf at the ayah currently being recited and highlights it.
  void _openCurrentVerse(BuildContext context, PlaybackState state) {
    final surahId = state.surahId;
    final verseNumber = state.currentVerseNumber;
    if (surahId == null || verseNumber == null) return;
    final verses = HiveService.getVersesBySurah(surahId);
    final verse =
        verses.where((v) => v.verseNumber == verseNumber).firstOrNull;
                        ...
                        children: [
                          ...
                          if (state.surahId != null &&
                            ...
                            IconButton(
                              ...
                              color: AppColors.primaryGreen,
                              iconSize: 22,
                              tooltip: l10n.jumpToVerse,
                              onPressed: () =>
                                  _openCurrentVerse(context, state),
